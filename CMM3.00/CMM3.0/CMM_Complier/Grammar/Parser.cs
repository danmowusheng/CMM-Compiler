    ...
    class Parser
    {
        ...
        private Node PreWork() {
            ...
            while (count < 4) {
                ...
                if (tmp == null) {
                    this.errowStr = "EEROR at line " + line + "\n";
                ...
                if (p[1].Equals("int") || p[1].Equals("double"))
                {
                    ...
                    {
                        this.errowStr = "EEROR at line " + line + " near '" + p[1] + "'" + "\n";
                ...
                else if (p[1].Equals(")"))
                {
                    ...
                    this.errowStr = "EEROR at line " + line + " near '" + tmp + "'" + "\n";
        ...
        public Node Analyze(){
            try
            {
                if (!Initialize(URL))
                {
                    this.errowStr = "Initialization failed" + "\n";
                ...
                while (tmp != null || NodeStack.Count != 0)
                {
                    ...
                    else
                    {
                        ...
                        if (x == -1)
                        {
                            this.errowStr = "ERROR at line " + line + " near '" + s[1] + "'"+ "\n";
                        ...
                        {
                            this.errowStr = "ERROR at line " + line + " near '" + s[1] + "'" + x + " " + state + "\n";
        ...
        public void get(Node s)
        {
            if (s == null)
            {
                MessageBox.Show("语法树生成失败");
            }
            else
            {
                if (s.Next == null)
